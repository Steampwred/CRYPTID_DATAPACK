...
execute if score .global cryptid.day matches 5.. if entity @s[tag=!cryptid,type=!marker,type=!armor_stand,type=!zombified_piglin,type=!#cryptid:nonliving] run function cryptid:action/hostile/infestinit
