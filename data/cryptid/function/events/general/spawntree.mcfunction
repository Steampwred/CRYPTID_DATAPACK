...
execute if score @s cryptid.player.random matches 1..3 run place feature cryptid:tree1
execute if score @s cryptid.player.random matches 4..5 run place feature cryptid:tree2
