...
# INVALID alter 
execute anchored feet positioned ~ ~-4 ~ unless predicate cryptid:alter/revival unless predicate cryptid:alter/voidtotem run scoreboard players set @s cryptid.timer 200