...
execute if entity @s[tag=ritual.translate,tag=!ritual.failure] run tellraw @a[distance=..15] {"text":"Ritual Codename:","color":"dark_purple","bold":true,"extra":[{"text":" VOID TOTEM","color":"aqua","bold":false}]}
