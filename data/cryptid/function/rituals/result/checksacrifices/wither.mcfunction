...
execute as @e[distance=0.5..11,type=wither,tag=sacrifice.mob] run scoreboard players add @n[distance=..11,tag=cryptid.orifice,type=zombie] cryptid.ritual.sacrificecounter 1
...
function cryptid:action/give/givehand