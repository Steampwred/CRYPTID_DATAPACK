...
execute as @e[distance=0.5..11,type=warden,tag=sacrifice.mob] run scoreboard players add @n[distance=..11,tag=cryptid.orifice,type=zombie] cryptid.ritual.sacrificecounter 1
