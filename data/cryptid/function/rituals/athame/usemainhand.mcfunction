## Summon blade
execute anchored feet run summon item_display ^ ^-0.5 ^0.4 {Tags:["cryptid","cryptid.athameproj"],id:"minecraft:item_display",item:{id:"minecraft:air",Count:1},item_display:"none",transformation:[1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f],teleport_duration:0}
...
scoreboard players set @s cryptid.athame.cooldown 180
