...
execute if score @s cryptid.player.random matches 1..10 run execute as @e[tag=cryptid,tag=!cryptid.ignore.totemward, distance=0..10, sort=nearest, limit=1] at @s run spreadplayers ~ ~ 50 90 false @s
