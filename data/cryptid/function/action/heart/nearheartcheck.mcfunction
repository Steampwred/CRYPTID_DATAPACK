...
###portal
execute if score .global cryptid.world.fury matches 2150.. if score @s cryptid.random matches 1..2 run execute as @p[distance=0..10] at @s run function cryptid:action/portal/create
