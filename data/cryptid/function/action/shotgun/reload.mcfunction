...
execute if items entity @s weapon.* minecraft:crossbow[custom_data~{cryptid.maxammo:4}] run scoreboard players set @s cryptid.shotgunammo3 4

execute if items entity @s weapon.* minecraft:crossbow[custom_data~{cryptid.maxammo:1}] run tag @s add reloaded1
execute if items entity @s weapon.* minecraft:crossbow[custom_data~{cryptid.maxammo:2}] run tag @s add reloaded2
execute if items entity @s weapon.* minecraft:crossbow[custom_data~{cryptid.maxammo:4}] run tag @s add reloaded3
