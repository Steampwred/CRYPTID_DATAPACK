...
#effect give @n[tag=cryptid,limit=1,type=!marker,type=!armor_stand,tag=!cryptid.radarignore] minecraft:glowing 1 0 true

execute positioned ~ ~1 ~ facing entity @n[tag=cryptid,type=!marker,type=!armor_stand,tag=!cryptid.radarignore] feet positioned ^-0.013 ^.001 ^0.4 run particle minecraft:electric_spark ~ ~0.6 ~ 0 0 0 0 1
