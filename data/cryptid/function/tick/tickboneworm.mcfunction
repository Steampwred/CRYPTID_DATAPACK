...
#infest single mob
execute if score @s cryptid.player.random matches 1..500 as @e[type=!player, type=!#cryptid:projectiles, type=!item, type=!villager, type=!armor_stand, tag=!cryptid, type=!marker, distance=..5,type=!experience_orb] run function cryptid:action/hostile/infestinit
