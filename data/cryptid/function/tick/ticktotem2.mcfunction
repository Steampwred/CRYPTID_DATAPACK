...
execute if entity @e[tag=cryptid, distance=0..53,tag=!cryptid.ignore.totemward,limit=1] run function cryptid:action/totem2/flickertotem2
execute as @e[tag=cryptid, distance=0..53,tag=!cryptid.ignore.totemward,limit=1] at @s run function cryptid:events/quietkill
